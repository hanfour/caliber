...
// It only checks registration + Use string — it must NOT invoke RunE, since
// on darwin that would shell out to the real launchctl and mutate the dev
// machine's LaunchAgents.
